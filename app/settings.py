...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-tn1e31md6pc0c9f@yqi#h0vfyatcx##i!kuy-hab3xeu@jx03l')
...
# Usa sqlite3 se DEBUG for True, PostgreSQL se for false
if DEBUG:
    DATABASES = {
        'default': {
